# -*- coding: utf-8 -*-
#
# aad_client documentation build configuration file, created by
...
htmlhelp_basename = 'aad_clientdoc'
...
latex_documents = [
  ('latex', 'aad_client.tex', u'aad_client',
...
texinfo_documents = [
  ('index', 'aad_client', u'aad_client',
    __author__, 'aad_client', 'Python Client for Packages Authenticating with Azure Active Directory',
   'Miscellaneous'),
]
